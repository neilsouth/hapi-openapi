...
const create = async function (server, { api, basedir, cors, vhost, handlers, extensions, outputvalidation, allowEmptyStrings }) {
    const routes = [];
    const validator = Validators.create({api, allowEmptyStrings });
