...
const optionsSchema = Joi.object({
    ...
    allowEmptyStrings: Joi.boolean().default(false)
}).required();
...
const register = async function (server, options, next) {
    ...
    const { api, cors, vhost, handlers, extensions, outputvalidation, allowEmptyStrings } = validation.value;
    ...
    const routes = await Routes.create(server, { api: spec, basedir, cors, vhost, handlers, extensions, outputvalidation, allowEmptyStrings });
